...
class VanillaVAE(pl.LightningModule):
    def __init__(self,
        ...
        self.example_input_array = torch.rand(1, 1, 512,512)
        ...
        modules.append(
            ...
            nn.ReLU(),
            nn.BatchNorm2d(4),
            nn.Conv2d(4,16,6,2,2),
            nn.ReLU(),
            nn.BatchNorm2d(16),
            nn.Conv2d(16,32,6,2,2),
            nn.ReLU(),
            nn.BatchNorm2d(32),
            nn.Conv2d(32,64,6,2,2),
            nn.ReLU(),
            nn.BatchNorm2d(64),
        ...
        self.fc_mu = nn.Linear(16384, 8192)
        self.fc_var = nn.Linear(16384, 8192)


        # Build Decoder
        modules = []

        self.decoder_input = nn.Linear(8192, 16384)
        ...
        modules.append(
            nn.Sequential(
                ...
                nn.BatchNorm2d(16),
                nn.ReLU(),
                nn.ConvTranspose2d(16,4,6,2,2),
                nn.BatchNorm2d(4),
                nn.ReLU(),
                nn.ConvTranspose2d(4,1,6,2,2),
                nn.BatchNorm2d(1),
                nn.ReLU()
            ))
