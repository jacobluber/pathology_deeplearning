...
class customVAE(VAE):
    def __init__(self,latent_dim,enc_out_dim,enc_type,first_conv,maxpool1, *args, **kwargs):
        ...
        super(customVAE, self).__init__(latent_dim=int(latent_dim),enc_out_dim=int(enc_out_dim),enc_type=enc_type,first_conv=first_conv,maxpool1=maxpool1,input_height=64,input_channels=1,*args)
