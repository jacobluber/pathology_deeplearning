...
if __name__ == '__main__':
    ...
    new_model = customVAE.load_from_checkpoint(checkpoint_path="/data/luberjm/tb_logs/best_distrib_2_v100_large_single.out/version_0/checkpoints/epoch=16-step=44284.ckpt")
    #trainer.fit(autoencoder,train_loader)
