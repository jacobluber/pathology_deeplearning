...
if __name__ == '__main__':
    ...
    if args.accelerator == "ddp":
        rddp = True
    trainer = pl.Trainer(max_epochs=args.epochs, replace_sampler_ddp=rddp, gpus=args.gpus,logger=tb_logger,num_nodes=args.nodes,accelerator=args.accelerator,auto_lr_find=False,benchmark=True,fast_dev_run=False,sync_batchnorm=True) #flush_logs_every_n_steps=1
