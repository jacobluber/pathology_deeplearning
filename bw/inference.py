...
if __name__ == '__main__':
    ...
    new_model = customVAE.load_from_checkpoint(checkpoint_path="/data/luberjm/tb_logs/normal_patches_color_normed/version_0/checkpoints/epoch=15-step=41679.ckpt")
    #trainer.fit(autoencoder,train_loader)
